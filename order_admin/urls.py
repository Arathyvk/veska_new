...
urlpatterns = [
    ...
    path('<uuid:uuid>/status/',                 views.order_update_status,           name='admin_order_update_status'),
    path('<uuid:uuid>/send_status/',            views._send_status_update_email,     name='_send_status_update_email'),
